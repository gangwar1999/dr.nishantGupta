...
<head>
	...
	<title>Top Cardiologist in Bareilly - Best Heart Specialist in Bareilly - Comprehensive Cardiac Care Expert - Dr. Nishant Gupta - No. 1 Cardiologist in Bareilly - UP </title>
    ...
    <div class="page-wrapper">
        ...
        <main class="main">
            ...
            <div class="container apppointment-step-2-section">
                <div class="row">
                    <div class="col-lg-8 offset-lg-0 col-sm-8 offset-sm-2 col-10 offset-1 text-center">
                        <h2 class="ls-n-20 line-height-1">Book Appointment</h2>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-8 offset-lg-0 col-sm-8 offset-sm-2 col-10 offset-1">
                        <form class="appoint-form mb-3">
                            ...
                            <div class="term-privacy d-flex justify-content-center m-b-3">
                                <span>Already have an account?</span><div class="btn-link"><a href="#">Sign in</a></div>
                            </div>
                        </form>
                    </div>
                    <div class="col-lg-4 offset-lg-0 col-sm-8 offset-sm-2 col-10 offset-1">
                        <div class="image-box">
                            <figure>
                                <img src="assets/images/team/Dr_kalim_sir.webp" class="w-100" alt="Doctor" width="370" height="407">
                            </figure>
                            <div class="box-content box-doctor">
                                <h4 class="box-title mb-0">Dr. Mohd.Kaleem (MD, DM)</h4>
                            ...
                            <div class="box-content box-content-clock mt-1">
                                <h3 class="box-title m-b-1"><i class="far fa-clock"></i>24*7</h3>
                                <span class="box-desc mb-0 ls-0">
                                24x7 Emergency Cardiac Care, Echo, TMT. Agiography, Agioplasty, Pacemaker Implantation and Treatment for all Heart Diseases
                                </span>
                            </div>
                        </div>
                    </div>
