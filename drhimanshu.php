            ...
            <div class="container apppointment-step-2-section">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 offset-lg-0 col-sm-8 offset-sm-2 col-10 offset-1">
                        <div class="image-box">
                            <figure>
                                <img src="assets/images/team/Himanshu-sir.webp" class="w-100" alt="Doctor" width="370" height="407">
                            </figure>
                            <div class="box-content box-doctor">
                                <h4 class="box-title mb-0">Dr.Himanshu Joshi (DNB)</h4>
                            ...
                            <div class="box-content box-content-clock mt-1">
                                ...
                                <span class="box-desc mb-0 ls-0">
                                24x7 Emergency Cardiac By-Pass Surgery, Valve Repair, Valve Replacement and Thoracic Trauma Management
                                </span>
                            </div>
                        </div>
                    </div>
