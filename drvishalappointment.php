            ...
            <div class="container apppointment-step-2-section">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 offset-lg-0 col-sm-8 offset-sm-2 col-10 offset-1">
                        <div class="image-box">
                            <figure>
                                <img src="assets/images/team/Dr_Vishal_PNG.webp" class="w-100" alt="Doctor" width="370" height="407">
                            </figure>
                            <div class="box-content box-doctor">
                                <h4 class="box-title mb-0">Dr. Vishal Agarwal (M.S., M.Ch.)</h4>
                                ...
                                Director and HOD CTVS surgeon
                                </span>
                            </div>
                            <div class="box-content box-content-clock mt-1">
                                <h4 class="box-title m-b-1"><i class="far fa-clock"></i>24*7</h4>
                                <span class="box-desc mb-0 ls-0">
